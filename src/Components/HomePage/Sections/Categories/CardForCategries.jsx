...
function CardForCategries() {
  return (
    <div className="flex justify-between gap-6 my-20 md:flex-nowrap flex-wrap">
      <div className="group border border-gray-400 rounded  md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        <svg
          width="56"
          height="56"
          viewBox="0 0 56 56"
        ...
        >
          <g clip-path="url(#clip0_7867_613)">
            <path
      ...
      <div className="group border border-gray-400 rounded  md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        ...
        <h3 className="mt-5">Computers</h3>
      </div>
      <div className="group border border-gray-400 rounded md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        <svg
          width="56"
          ...
          className="group-hover:text-white mx-auto"
        >
          <g clip-path="url(#clip0_7867_629)">
            <path
          ...
          <defs>
            <clipPath id="clip0_7867_629">
              <rect width="56" height="56" fill="white" />
            </clipPath>
          </defs>
        </svg>

        <h3 className="mt-5">SmartWatch</h3>
      </div>
      <div className="group border border-gray-400 rounded  md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        <svg
          width="56"
        ...
        >
          ...
          <defs>
            <clipPath id="clip0_7867_6">
              <rect width="56" height="56" fill="white" />
            </clipPath>
          </defs>
        </svg>

        <h3 className="mt-5">Camera</h3>
      </div>
      <div className="group border border-gray-400 rounded md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        <svg
          width="56"
          ...
          className="group-hover:text-white mx-auto"
        >
          <g clip-path="url(#clip0_7867_644)">
            <path
          ...
          <defs>
            <clipPath id="clip0_7867_644">
              <rect width="56" height="56" fill="white" />
            </clipPath>
          </defs>
        </svg>

        <h3 className="mt-5">HeadPhones</h3>
      </div>
      <div className="group border border-gray-400 rounded  md:w-1/6 w-full text-center py-7 cursor-pointer hover:text-white hover:bg-[#DB4444]">
        <svg
          width="56"
          ...
          className="group-hover:text-white mx-auto"
        >
          <g clip-path="url(#clip0_7867_809)">
            <path
          ...
          <defs>
            <clipPath id="clip0_7867_809">
              <rect width="56" height="56" fill="white" />
            </clipPath>
          </defs>
        </svg>

        <h3 className="mt-5">Gaming</h3>
      </div>
    </div>
  );
}

export default CardForCategries;
