...
function ProductsCardBestSelling({
  product,
  index
}) {
  ...
  return (
    ...
    >
      <div className="group  relative bg-gray-100 p-16">
        <div className={`absolute flex justify-between  ${persent?"top-5 left-5 right-5":"right-5 top-5"}`}>
          {persent ? (
...
export default ProductsCardBestSelling