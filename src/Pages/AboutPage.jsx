...
import background from "../imgs/Side Image.svg";

// icons
import iconInstagram from "../imgs/icon-instagram.svg";
import iconTwitter from "../imgs/Icon-Twitter.svg";
import iconLinkedin from "../imgs/Icon-Linkedin.svg";

// images persons
import img1 from "../imgs/Frame 874.svg";
import img2 from "../imgs/Frame 875.svg";
import img3 from "../imgs/Frame 876.svg";
...
function AboutPage() {
  return (
    <div className="">
      ...
      <div className="w-5/6 mx-auto flex flex-col lg:flex-row justify-center lg:justify-between space-y-5 lg:space-y-0 items-center mt-16">
        <div className="lg:w-1/2 w-full pr-10 ">
          <h1 className="font-bold text-5xl my-6">Our Story</h1>
        ...
        <img src={background} alt="background" className="lg:w-1/2 w-full" />
      </div>

      {/* list */}
      <div className="w-5/6 mx-auto flex space-y-5 lg:space-y-0 space-x-0 lg:space-x-7 flex-col lg:flex-row justify-center lg:justify-between py-28">
        <div className="group border border-gray-300 space-y-3 py-8 rounded text-center hover:bg-red-500 hover:text-white cursor-pointer lg:w-1/4 w-full">
          <div className="flex justify-center">
            <svg
              viewBox="0 0 41 40"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="group-hover:text-black group-hover:border-gray-300 group-hover:bg-white p-3 w-20 text-white bg-black rounded-full border-[10px] border-gray-400"
            >
              <path
          ...
          <h3 className="text-lg font-medium">Sallers active our site</h3>
        </div>
        ...
        <div className="group border border-gray-300 space-y-3 py-8 rounded text-center hover:bg-red-500 hover:text-white cursor-pointer lg:w-1/4 w-full">
          ...
          <h3 className="text-lg font-medium">Mopnthly Produduct Sale</h3>
        </div>
        ...
        <div className="group border border-gray-300 space-y-3 py-8 rounded text-center hover:bg-red-500 hover:text-white cursor-pointer lg:w-1/4 w-full">
          ...
          <h3 className="text-lg font-medium">Customer active in our site</h3>
        </div>
        ...
        <div className="group border border-gray-300 space-y-3 py-8 rounded text-center hover:bg-red-500 hover:text-white cursor-pointer lg:w-1/4 w-full">
          ...
          <h3 className="text-lg font-medium">Anual gross sale in our site</h3>
        </div>
      </div>

      {/* persons */}

      <div className="w-5/6 mx-auto flex flex-col lg:flex-row justify-center lg:justify-between">
        {/* person 1 */}
        <div>
          <img src={img1} alt="person 1" />
          <div className="space-y-3 mt-5">
            <h1 className="text-4xl">Tom Cruise</h1>
        ...
        <div>
          ...
          <div className="space-y-3 mt-5">
            <h1 className="text-4xl">Emma Watson</h1>
        ...
        <div>
          ...
          <div className="space-y-3 mt-5">
            <h1 className="text-4xl">Will Smith</h1>
      ...
      {/* dots */}
      <div class="flex justify-center items-end space-x-4 pb-3 mt-10">
        <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
        <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
        <div class="w-3 h-3 bg-[#DB4444] border-2 border-gray-400 rounded-full"></div>
        <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
        <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
      </div>
